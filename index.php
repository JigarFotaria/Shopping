      ...
      <main class="container">
                  ...
                  <div class="item active">
                     <div class="rows d-flex">
                        <div class="col-xs-12 col-md-5 col-md-offset-1">
                           ...
                           <a class="btn-shop" href="product-details.php">Shop Now</a>
                        </div>
         ...
         <div class="row ">
            <div class="col-xs-12 text-center ">
               <h2 class="h-headings"><span class="color-red">Discounted</span> Products</h2>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 prd-slider">
         ...
         <div class="row">
            <div class="col-xs-12 text-center ">
               <h2 class="text-center h-headings">Most <span class="color-green">Popular</span> Products</h2>
            </div>
         ...
         <div class="row">
            <div class="col-xs-12 text-center">
               <h2 class="h-headings">Best <span class="color-green">selling</span> Products</h2>
            </div>
            <div class="col-xs-12 prd-slider">
               <div class="owl-carousel owl-theme ol1">
                  <div class="item">
